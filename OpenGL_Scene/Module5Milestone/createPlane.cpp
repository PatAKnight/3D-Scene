...
*/
void Plane::transformation(GLint modelLoc, glm::vec3 meshScale, glm::vec3 meshPosition, float degree) {
...
*/
void Plane::setShaderInfo(GLuint program, glm::vec3 objectColor, glm::vec3 lightColor, glm::vec3 lightPosition) {
